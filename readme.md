...
## 💻 Projeto
O GITFAV★ é uma aplicação que oferece uma visão rápida e abrangente de perfis do GitHub. Ao digitar o nome de usuário na barra de busca, a aplicação fornece instantaneamente a foto de perfil, número de seguidores e quantidade de repositórios públicos daquele usuário, encurtando o caminho para seus user's favoritos. 
...
- [Visite o projeto online](https://julianomariano.github.io/GITFAV-/)
